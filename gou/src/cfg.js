...
var AJAX_ENDPOINTS = {
	...
	spec_queries: "https://marselha.cm-porto.net/riscosrv_v2bdt_dev/doget"
}
...
var RECORD_PANELS_CFG = {
	main: {
		...
		attr_cfg: {
			...
			num_policia: ["Número polícia", "splitcommas"],
			npno: ["Outros núm.polícia", "splitcommas"],
			andar: ["Andar", null],
			...
			despacho_final: ["Despacho final", null, {
				"deferido": "#3ea56d", 
				"caducidade": "#a53d43"
			}],
			data_despacho:  ["Data despacho", null],
			estado_processo:  ["Estado processo", null, {
				"concluído": "#c42f2f",
				"em curso": "#20d8a1" 
			}],
...
var INTRO_MSG = "Introduza um topónimo ou uma morada.<br/><br/> Deve clicar num dos polígonos ou pontos do mapa para ver os dados associados.";
